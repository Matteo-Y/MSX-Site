        ...
        <div id="two-column-container">
            ...
            <div style={{display: "flex", flexDirection: "column", flex: " 1 1 0"}}>
                <div style={{margin: "30px"}} className="link-table">
                    ...
                    <div style={{backgroundColor: "#bbb"}} className="download-tab"><a className="download-link" href={require("../Downloads/res/files/default_firmware.zip")}    download>default_factory_firmware</a></div>
                    <div style={{backgroundColor: "#f9f9f9"}} className="download-tab"><a className="download-link" href={require("../Downloads/res/files/finger_robot.zip")}        download>sawy-sawy_claw_robot</a></div>
                    <div style={{backgroundColor: "#bbb"}} className="download-tab"><a className="download-link" href={require("../Downloads/res/files/line_follower_robot.zip")} download>line_follower_code</a></div>
                </div>
                <div style={{margin: "30px"}} className="link-table">
